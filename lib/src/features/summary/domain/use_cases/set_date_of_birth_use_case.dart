...
class SetDateOfBirthUseCase extends UseCase<void, SingleStringParams> {
  final SummaryRepository repository;

  SetDateOfBirthUseCase(this.repository);

  @override
  Future<Either<Failure, void>> call(SingleStringParams params) async {
    return await repository.setDateOfBirth(params.value);
  }
}
